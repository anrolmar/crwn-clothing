...
type SignOutFailed = ActionWithPayload<USER_ACTION_TYPES.SIGN_OUT_FAILED, string>;
...
export const signOutFailed = withMatcher(
  (error: string): SignOutFailed => createAction(USER_ACTION_TYPES.SIGN_OUT_FAILED, error),
);
